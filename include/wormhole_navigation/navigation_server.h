...
#include <wormhole_navigation/NavigateToGoalAction.h>
...
public:
    ...
    void execute(const wormhole_navigation::NavigateToGoalGoalConstPtr& goal);

private:
    ros::NodeHandle nh_;
    actionlib::SimpleActionServer<wormhole_navigation::NavigateToGoalAction> as_;
